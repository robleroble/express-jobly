...
describe("GET /companies", function () {
  ...
  test("gets company by name", async function () {
  ...
  test("causes error with invalid query", async function () {
    const resp = await request(app).get("/companies?nameeee=hellothere");
